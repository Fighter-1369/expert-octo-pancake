...
mycursor.execute("create table if not exists patients(sno varchar(25) primary key, name varchar(25) not null, age varchar(25) not null, city varchar (30) not null, state varchar (30) not null, phone_no bigint(40) not null, Bloodgroup varchar(10) not null ,gender varchar(25) not null, date date not null)")
            ...
            while(loop2=='n' or loop2=='N'):
                ...
                if(ch2==1):
                    ...
                    if  (idd==1):
                        ...
                        mycursor.execute("Update Patient  Set  age='"+"'where sno='"+a+"'")
